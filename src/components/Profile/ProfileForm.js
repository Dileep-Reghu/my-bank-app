          ...
          <Col md={colWidth}>
            <div className={classes.control}>
              <label
                ...
                htmlFor="accountType"
              >
                Account Type {isEditing && (<span className={classes.span}>*</span>)}
              </label>
            </div>
          </Col>
          <Col md={4}>
            ...
            <Col md={colWidth}>
              <div className={classes.control}>
                <label
                  ...
                  htmlFor="email"
                >
                  Email {isEditing && (<span className={classes.span}>*</span>)}
                </label>
              </div>
            </Col>
            <Col>
          ...
          <Col md={colWidth}>
            <div className={classes.control}>
              <label
                ...
                htmlFor="dob"
              >
                Date of Birth {isEditing && (<span className={classes.span}>*</span>)}
              </label>
            </div>
          </Col>
          <Col md={4}>
